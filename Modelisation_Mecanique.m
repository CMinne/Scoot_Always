...
plot(num(:,2),v2,x,v1)
%%
dv1 = diff(v1,1)/Te % on fait la dérive de la vitesse pour avoir l'acceleration
dv2 = diff(v2,1)/Te % on fait la dérive de la vitesse pour avoir l'acceleration
% la période est prise 
